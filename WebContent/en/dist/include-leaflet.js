(function () {
    ...
    function load() {
        ...
        if (inArray(includes, 'leaflet.miniMap')) {
            inputCSS("../../../web/libs/leaflet/plugins/leaflet-miniMap/dist/Control.MiniMap.min.css");
            inputScript("../../../web/libs/leaflet/plugins/leaflet-miniMap/dist/Control.MiniMap.min.js");
        }
